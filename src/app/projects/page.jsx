...
export default function Projects() {
  ...
  // ✅ 오른쪽 리스트용: stableBase를 절대 변형하지 않기 위해 복사 후 정렬
      ...
      <div className="SortingBarList">
        ...
        >
          ...
          <svg width="13" height="8" viewBox="0 0 13 8" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0.466553 0.466797L6.41699 6.41724L12.3674 0.466797" stroke="white" strokeWidth="1.32"/>
          </svg>
        </div>
            ...
            <div className="keyWardList">
              {allTarget.map((targetName) => {
                ...
                return (
                  <div
                    className={`sortButton ${
                      activeFilters.target.has(targetName) ? "active" : ""
                    } ${isReappearing ? "re-entering" : ""}`}
        ...
        >
          ...
          {rightList.map((p, idx) => {
            ...
            return (
              <div
                key={p.id}
                className={`projectNameCard ${isVisible ? "is-visible" : "is-hidden"}`}
                ref={(node) => {
